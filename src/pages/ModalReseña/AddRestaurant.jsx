      ...
      <Formik
        ...
        onSubmit={async (values, { setSubmitting, resetForm, setErrors }) => {
          try {
            ...
            const resultAction = await dispatch(createRestaurantOnReview(formattedValues));
            ...
            if (createRestaurantOnReview.fulfilled.match(resultAction)) {
              ...
              setErrors({ restaurantName: resultAction.payload || 'Error al crear el restaurante' });
            }
          } catch (error) {
            console.error("Error al crear el restaurante:", error);
            setErrors({ restaurantName: 'Error inesperado al crear el restaurante.' });
          } finally {
            setSubmitting(false);
          }
        }}
          ...
          <Form className="flex flex-col">
            ...
            <div className="mb-4">
              <Field
                ...
                className={`w-full p-2 border border-gray-300 rounded ${errors.restaurantName && touched.restaurantName ? 'border-red-500' : ''
                  }`}
              />
              <ErrorMessage
                name="restaurantName"
            ...
            <div className="mb-4">
              <Field
                ...
                className={`w-full p-2 border border-gray-300 rounded ${errors.address && touched.address ? 'border-red-500' : ''
                  }`}
              />
              <ErrorMessage
                name="address"
            ...
            <div className="mb-4">
              <Field
                name="city"
                placeholder="Ciudad"
                className={`w-full p-2 border border-gray-300 rounded ${errors.city && touched.city ? 'border-red-500' : ''
                  }`}
              />
              <ErrorMessage
                name="city"
            ...
            <button
              type="submit"
              className={`w-full py-2 rounded-lg transition duration-300 ${isValid && dirty
